...
from model import CLAM_MB, Encoder, TransMIL, DSMIL, Additive_MIL, Attention_MIL
from utils import get_features_and_split, get_generator_instances, generate_list_instances, save_prediction_binary, save_loss_function, save_hyperparameters
...
parser.add_argument('-m', '--MAG', help='magnification to select',type=str, default='5')
...
save_prediction_binary(checkpoint_path, phase, None, preds, DATASET)
